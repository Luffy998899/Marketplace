...
export function FeaturedStrip() {
  ...
  return (
    <section className="relative mb-8">
      ...
      <div className="thin-scroll -mx-4 flex gap-3 overflow-x-auto px-4 pb-2 sm:-mx-6 sm:px-6">
        {featured.map((c, i) => (
          <motion.div
            key={c.id}
          ...
          >
            <Link
              ...
              className="group relative block h-[220px] w-[165px] overflow-hidden rounded-card border border-border bg-surface sm:h-[280px] sm:w-[210px]"
            >
              <BlurImage
                src={c.cover.url}
                alt={c.name}
              ...
              <div className="absolute inset-x-0 bottom-0 p-3">
                <p className="truncate font-display text-xs font-bold uppercase tracking-wide text-ink">
                  {c.name}
                </p>
